...
const WriteConcert = () => {
  ...
  const handleChange = (event, data) => {
    switch (data) {
      ...
      case "check":
        setClick(!click);
        break; // 선예매 유무에 따라 날짜/ 시간 다르게 나타나게
      case "link":
  ...
  const popup = () => {
    return (
      <>
        {click === true && (
          <div style={{ margin: `10px 0 20px 0`, fontSize: "10px" }}>
        ...
        <form>
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <p style={{ fontSize: "10px" }}>
              ...
              <input
                type="checkbox"
                onClick={(e) => handleChange(e, "check")}
                style={{ margin: "10px", backgroundColor: "#B5EBEB" }}
              />{" "}
            </p>
            <div> {popup()} </div>

            <div style={{ margin: "10px 0 20px 0" }}>
              <label htmlFor="ticketDate" style={{ fontSize: "10px" }}>
                티켓팅 날짜 / 시작 시간{" "}
              </label>
              <br />
              <Date type="date" />
